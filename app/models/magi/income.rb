...
module MAGI
  class Income < Ruleset
    input "Application Year", "From application", "Integer", [2013, 2014, 2015, 2016]
    ...
    rule "Set Income as Percent FPL" do
      o["Calculated Income as Percentage of FPL"] = (Float(v("Calculated Income")) / Float(v("FPL")) * 100.0).round(2)#floor
    end
